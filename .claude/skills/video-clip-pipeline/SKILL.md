...
description: AI-powered pipeline that converts long-form YouTube episodes into standalone highlight clips: download, transcribe, AI segment, cut, upload. Use when converting long-form YouTube content into highlight clips, processing a YouTube back catalog into a clips channel, or cutting video clips with verified sentence boundaries.
---
