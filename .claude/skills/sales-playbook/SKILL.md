---
name: sales-playbook
description: Value-based pricing framework that moves deals from $10K/mo to $40-100K/mo: pre-call briefings, tiered package generation, post-call analysis, and a pattern library for training sales teams. Use when preparing for a sales call, building tiered pricing proposals, analyzing sales call transcripts against the value-based pricing framework, or training reps on pricing patterns and objection handling.
---
