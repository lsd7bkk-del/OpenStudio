---
name: conversion-ops
description: AI-powered conversion rate optimization: landing page audits, CRO scoring, survey segmentation, and lead magnet generation. Use when asked for a landing page audit, CRO analysis, scoring a page's conversion dimensions, identifying conversion bottlenecks on a URL, segmenting survey respondents by pain point, or generating lead magnet ideas from survey data.
---
