---
name: sales-pipeline
description: Complete AI-powered sales pipeline automation: website visitor identification, intent scoring, suppression, campaign routing, dead deal resurrection, trigger prospecting, and self-learning ICP optimization. Use when setting up automated outbound from website visitor identification (RB2B), running suppression checks before cold outreach, routing leads to cold email campaigns, or reviving closed-lost deals from HubSpot.
---
